...
public class SingleTask1 extends TaskContent {
    ...
    public void customLevel()throws Exception{
        new SingleTask1(mFairy){
            ...
            @Override
            public void content_0() throws Exception {
                result1=mFairy.findPic( 871,358,1273,697,new String[]{"start_action1.png","start_action.png"} );
                ...
                mFairy.onTap(0.8f, result1, "开始作战", 1000);
                ...
                result = mFairy.findPic(41,74,422,405,new String[]{"action_over.png","action_over1.png"});//行动结束
    ...
    public void content_2()throws Exception{
        ...
        result=mFairy.findPic( 710,67,1233,664,"start_action1.png");//开始行动
        if(result.sim > 0.8f){
